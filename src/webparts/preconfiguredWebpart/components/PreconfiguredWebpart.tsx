...
import styles from './PreconfiguredWebpart.module.scss';
import { IPreconfiguredWebpartProps } from './IPreconfiguredWebpartProps';
import { escape } from '@microsoft/sp-lodash-subset';

export default class PreconfiguredWebpart extends React.Component<IPreconfiguredWebpartProps, {}> {
  public render(): React.ReactElement<IPreconfiguredWebpartProps>
   {
     if(this.needsConfiguration()){
       ...
       return (
       <div className={styles.preconfiguredWebpart}>
  ...
  private needsConfiguration() :boolean{
    return  PreconfiguredWebpart.isEmpty(this.props.listName) ||
            PreconfiguredWebpart.isEmpty(this.props.order) ||
            PreconfiguredWebpart.isEmpty(this.props.style);
  }
